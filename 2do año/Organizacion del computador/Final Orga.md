...
- [[#¿Qué hace el CPU?|¿Qué hace el CPU?]]
- [[#Estructura|Estructura]]
- [[#Trayecto de datos de la CPU|Trayecto de datos de la CPU]]
- [[#[[Acceso a Memoria RAM]]|[[Acceso a Memoria RAM]]]]
- [[#Memoria|Memoria]]
- [[#Set de instrucciones|Set de instrucciones]]
- [[#Algunas instrucciones de ARC|Algunas instrucciones de ARC]]
	- [[#Algunas instrucciones de ARC#Registros de Accesibles al programador|Registros de Accesibles al programador]]
	- [[#Algunas instrucciones de ARC#Directivas al Ensamblador (ARCtools)|Directivas al Ensamblador (ARCtools)]]
	- [[#Algunas instrucciones de ARC#¿Qué es?|¿Qué es?]]
	- [[#Algunas instrucciones de ARC#Subrutinas vs Branch|Subrutinas vs Branch]]
	- [[#Algunas instrucciones de ARC#¿Cómo se llega/termina una subrutina?|¿Cómo se llega/termina una subrutina?]]
	- [[#Algunas instrucciones de ARC#¿Cómo se intercambian argumentos con una subrutina?|¿Cómo se intercambian argumentos con una subrutina?]]
- [[#Llamado a subrutinas|Llamado a subrutinas]]
	- [[#Llamado a subrutinas#¿Qué es una macro?|¿Qué es una macro?]]
- [[#[[Diferencias]]|[[Diferencias]]]]
- [[#Organización del [[#Trayecto de datos de la CPU]]|Organización del [[#Trayecto de datos de la CPU]]]]
- [[#ALU: Operaciones aritméticas en ARC|ALU: Operaciones aritméticas en ARC]]
	- [[#ALU: Operaciones aritméticas en ARC#Tabla de consulta (Look-up table)|Tabla de consulta (Look-up table)]]
	- [[#ALU: Operaciones aritméticas en ARC#Barrel-shifter|Barrel-shifter]]
- [[#Estructura interna de los registros|Estructura interna de los registros]]
	- [[#Estructura interna de los registros#Registros que no responden a la estructura general|Registros que no responden a la estructura general]]
- [[#Diseño de una unidad de control|Diseño de una unidad de control]]
- [[#Microarquitectura|Microarquitectura]]
		- [[#Registros que no responden a la estructura general#Control Store (ROM)|Control Store (ROM)]]
		- [[#Registros que no responden a la estructura general#MIR|MIR]]
		- [[#Registros que no responden a la estructura general#Ejecución del microcódigo:|Ejecución del microcódigo:]]
		- [[#Registros que no responden a la estructura general#IR con salidas por cada campo|IR con salidas por cada campo]]
- [[#Formato de palabra de microcódigo|Formato de palabra de microcódigo]]
- [[#Assembler vs Microprograma|Assembler vs Microprograma]]
	- [[#Assembler vs Microprograma#Programa en lenguaje de bajo nivel|Programa en lenguaje de bajo nivel]]
	- [[#Assembler vs Microprograma#Microprograma|Microprograma]]
- [[#Compiladores|Compiladores]]
	- [[#Compiladores#El proceso de compilación|El proceso de compilación]]
		- [[#El proceso de compilación#Mapeo de acciones|Mapeo de acciones]]
- [[#Ensamblador|Ensamblador]]
	- [[#Ensamblador#Obtención de código de máquina|Obtención de código de máquina]]
	- [[#Ensamblador#Proceso de ensamblado en dos pasadas|Proceso de ensamblado en dos pasadas]]
- [[#Creación de la tabla de símbolos|Creación de la tabla de símbolos]]
	- [[#Creación de la tabla de símbolos#Archivos creados por el ensamblador|Archivos creados por el ensamblador]]
	- [[#Creación de la tabla de símbolos#Localización del programa en memoria|Localización del programa en memoria]]
		- [[#Localización del programa en memoria#El ensamblador y el linker|El ensamblador y el linker]]
		- [[#Localización del programa en memoria#Referencias externas|Referencias externas]]
- [[#Carga de programa en memoria|Carga de programa en memoria]]
		- [[#Localización del programa en memoria#¿En qué dirección de memoria?|¿En qué dirección de memoria?]]
	- [[#Carga de programa en memoria#Linking & Loading|Linking & Loading]]
	- [[#Carga de programa en memoria#Archivos objeto|Archivos objeto]]
