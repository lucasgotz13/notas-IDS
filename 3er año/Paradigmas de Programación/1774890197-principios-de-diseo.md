...
- _Code smell_: Un indicio de que algo no está bien en el código.
- _Deuda técnica_: Es el costo implícito del trabajo adicional futuro resultante de elegir una solución sobre una más robusta.
- _Refactoring_: Proceso de reestructuración del código para mejorar su legibilidad, mantenibilidad y extensibilidad, sin cambiar su comportamiento externo.
